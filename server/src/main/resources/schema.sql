...
-- Индекс для быстрого поиска по owner_id и сортировки по created
CREATE INDEX IF NOT EXISTS idx_item_requests_owner_created ON item_requests(owner_id, created DESC);
